...
public class TreatmentFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView textView = fragmentView.findViewById( R.id.t3 ) ;
        textView.setTextIsSelectable( true ) ;
        String s = getContext().getResources().getString(R.string.t3);
        textView.setText( Html.fromHtml( s ) );

        TitleViewModel viewModel = ViewModelProviders.of( getActivity() ).get( TitleViewModel.class ) ;
        viewModel.setTitle( getString( R.string.treatment_and_cure ) ) ;
